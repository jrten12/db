        ...
        <div className="bg-gradient-to-br from-cyan-500/10 via-blue-500/10 to-sky-500/10 backdrop-blur rounded-2xl border-2 border-cyan-500/30 overflow-hidden shadow-2xl shadow-cyan-500/10">
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="col-span-full desk-panel rounded-lg p-4 border border-[rgba(180,140,70,0.25)]">
                <label className="text-[hsl(43_55%_68%)] text-sm font-medium mb-3 block font-display">
                  Finish Level
                </label>
                <div className="grid grid-cols-2 gap-2">
