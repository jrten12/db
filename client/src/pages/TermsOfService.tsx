    ...
    <div className="min-h-screen" style={{ background: '#0c0c0e' }}>
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="desk-surface rounded-lg p-8 shadow-xl">
          <h1 className="text-4xl font-display font-bold text-[hsl(43_60%_68%)] mb-6">Terms of Service</h1>
          ...
          <div className="space-y-6 text-gray-300">
            <section>
              ...
              <p>
                By accessing and using this website and services provided by Infarill LLC and LVI Properties, LLC ("Company", "we", "our", or "us"),
            ...
            <section>
              ...
              <p>
                Infarill LLC and LVI Properties, LLC provide an online real estate investment simulation and educational platform. The service is
            ...
            <section>
              ...
              <p>
                ...
                INVESTMENT, TAX, LEGAL, ACCOUNTING, OR PROFESSIONAL ADVICE OF ANY KIND. THE COMPANY PARTIES DO NOT RECOMMEND
                ...
                FINANCIAL DECISIONS. THE COMPANY PARTIES EXPRESSLY DISCLAIM ALL LIABILITY FOR ANY FINANCIAL LOSSES, INVESTMENT
            ...
            <section>
              ...
              <p>
                ...
                logos, icons, images, and software, are the exclusive property of Infarill LLC and LVI Properties, LLC, their affiliates, licensors,
            ...
            <section>
              ...
              <p>
                ...
                NON-INFRINGEMENT. NEITHER INFARILL LLC, LVI PROPERTIES, LLC, NOR THEIR AFFILIATES, SUBSIDIARIES, OFFICERS, DIRECTORS, EMPLOYEES,
                AGENTS, PARTNERS, LICENSORS, OR SERVICE PROVIDERS (COLLECTIVELY, THE "COMPANY PARTIES") MAKE ANY WARRANTY
                THAT THE SERVICE WILL BE UNINTERRUPTED, SECURE, ERROR-FREE, OR FREE FROM VIRUSES OR OTHER HARMFUL COMPONENTS.
                NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED FROM THE COMPANY PARTIES OR THROUGH THE SERVICE
            ...
            <section>
              ...
              <p>
                TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE COMPANY PARTIES BE LIABLE TO YOU
                ...
                LOSSES (EVEN IF THE COMPANY PARTIES HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES), WHETHER BASED ON
              ...
              <p className="mt-3">
                IN NO EVENT SHALL THE AGGREGATE LIABILITY OF THE COMPANY PARTIES EXCEED THE GREATER OF ONE HUNDRED DOLLARS
                ($100) OR THE AMOUNT YOU PAID TO THE COMPANY, IF ANY, IN THE PAST SIX MONTHS FOR THE SERVICE GIVING RISE
                TO THE CLAIM. THE LIMITATIONS OF THIS SECTION SHALL APPLY TO ANY THEORY OF LIABILITY, WHETHER BASED ON WARRANTY,
                CONTRACT, STATUTE, TORT (INCLUDING NEGLIGENCE), OR OTHERWISE, AND WHETHER OR NOT THE COMPANY PARTIES HAVE BEEN
            ...
            <section>
              ...
              <p>
                ...
                survive termination of these Terms and your use of the service. You agree that the Company Parties shall have
                the right to control the defense of any such claim, action, or proceeding, and you agree to cooperate fully with
                the Company Parties in such defense.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                The Company Parties may terminate or suspend your account and access to the service immediately, without
                ...
                to the service will not limit any of the Company Parties' other rights or remedies at law or in equity.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                These Terms, together with any amendments and any additional agreements you may enter into with the Company
                in connection with the service, shall constitute the entire agreement between you and the Company concerning
                the service. No failure or delay by the Company Parties in exercising any right, power, or privilege under
            ...
            <section>
              ...
              <p>
                YOU AND THE COMPANY PARTIES AGREE THAT EACH MAY BRING CLAIMS AGAINST THE OTHER ONLY IN YOUR OR ITS INDIVIDUAL CAPACITY
                AND NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY PURPORTED CLASS, CONSOLIDATED, OR REPRESENTATIVE ACTION. UNLESS
                BOTH YOU AND THE COMPANY PARTIES AGREE OTHERWISE, THE ARBITRATOR MAY NOT CONSOLIDATE MORE THAN ONE PERSON'S CLAIMS,
            ...
            <section>
              ...
              <p>
                The Company Parties shall not be liable for any failure or delay in performance under these Terms due to
