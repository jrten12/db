...
export const PROPERTY_UPGRADES: PropertyUpgrade[] = [
  ...
  // Note: HVAC replacement, window replacement, electrical panel, water heater, and
  // roof patches are intentionally NOT here. Those are maintenance/repairs, not
  // value-add renovations, and they surface in the repairs panel when inspection
  // or contractor walkthrough discovers the corresponding issues (outdated_hvac,
  // water_heater_age, electrical_outdated, roof_wear, etc.).
  {
