...
export function MarketBar({ condition, className = '', compact = false }: MarketBarProps) {
  ...
  return (
    <>
      <div 
        className={`
          flex items-center gap-2 rounded-lg desk-panel
      ...
      >
        <div className="flex items-center gap-1.5 flex-shrink-0">
          <span className="text-[10px] uppercase tracking-wider text-[hsl(35_15%_62%)] font-medium">Market</span>
          <button
      ...
      {showInfo && (
        ...
        >
          <div 
            className="desk-surface rounded-xl p-4 shadow-2xl"
            style={{ 
              position: 'fixed',
              top: '50%', 
              left: '50%', 
          ...
          >
            <div className="flex items-start justify-between gap-2 mb-2">
              ...
              <button
                onClick={() => setShowInfo(false)}
                className="w-8 h-8 flex items-center justify-center desk-panel rounded-full flex-shrink-0 touch-target-sm"
