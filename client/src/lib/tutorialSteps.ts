...
export const tutorialSteps: TutorialStep[] = [
  // PHASE 1: WELCOME
  {
    ...
    detail: 'You start with $75,000 in cash and 12 months on the clock. Your goal: complete 3 profitable deals before time runs out.',
    icon: 'wave',
    position: 'center',
    phase: 'welcome',
  },
  ...
  },
  {
    id: 'your_goal',
    title: 'Your Goal',
    content: 'Complete 3 profitable deals to win! A "profitable deal" means you made money - either from rent or from flipping.',
