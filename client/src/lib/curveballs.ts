...
export const NEGATIVE_CURVEBALLS: Curveball[] = [
  // === UNIVERSAL ISSUES (all property types) ===
  {
    ...
    probability: 6,
    timeImpact: 1,
    description: 'Tenant had a payroll issue - rent will be 1 month late.',
    emoji: '😬',
    color: 'yellow',
    tenantMessages: {
  ...
  // === FLIP-SPECIFIC ISSUES ===
  {
    ...
    probability: 10,
    timeImpact: 2,
    description: 'City permitting is backed up - 2 month delay on inspections.',
    emoji: '📋',
    color: 'yellow',
  },
  {
  ...
  },
  {
    ...
    probability: 10,
    timeImpact: 1,
    description: 'Your contractor had another job run long - 1 month delay.',
    emoji: '⏰',
    color: 'yellow',
  },
  {
